#!/bin/bash
TMP_DIR=/tmp/p2a_tmp
REQUIRED_FILES="readme.txt team.txt cleantext.py" 
...
if [ ! -f ${ZIP_FILE} ]; then
    echo "ERROR: Cannot find $ZIP_FILE, ensure this script is put in the same directory of your P2A.zip file. Otherwise check the zip file name" 1>&2
    rm -rf ${TMP_DIR}
    echo "rmd"
    exit 1
fi
...
echo "Check File Successfully. Please upload your P2A.zip file to CCLE."
rm -rf ${TMP_DIR}
exit 0
